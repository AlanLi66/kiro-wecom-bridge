...
SCENARIOS = [
    {
        ...
        "prompt": (
            ...
            "4. 检查 console 是否有 JS 错误\n"
            "5. 截图保存\n\n"
            "如果发现异常，详细描述问题。如果一切正常，简短确认。"
        ),
    },
    {
        "id": "search",
    ...
    },
    {
        ...
        "prompt": (
            ...
            "3. 点击加购按钮，验证是否有成功反馈（弹窗/数字变化）\n"
            "4. 检查 console 是否有 JS 错误\n"
            "5. 截图保存\n\n"
            "如果加购失败或页面异常，详细描述问题和可能原因。"
        ),
    },
    {
        "id": "cart",
        ...
        "prompt": (
            ...
            "1. 验证购物车页面正常加载\n"
            "2. 如果有商品，检查商品信息（名称、价格、数量）是否正常显示\n"
            "3. 如果购物车为空，确认空状态提示正常\n"
            "4. 检查 console 是否有 JS 错误\n"
            "5. 截图保存\n\n"
            "注意：这个页面需要登录态，如果跳转到登录页说明 cookie 过期。"
        ),
    },
    {
        "id": "account",
